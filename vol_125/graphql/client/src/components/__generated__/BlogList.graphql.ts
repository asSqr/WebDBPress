/**
 * @generated SignedSource<<bf387355d970b7e582a00d6116e37012>>
...
export type BlogList$data = {
  ...
  readonly " $fragmentType": "BlogList";
};
export type BlogList$key = {
  readonly " $data"?: BlogList$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./BlogListPaginationQuery.graphql')
    }
  },
  "name": "BlogList",
  "selections": [
